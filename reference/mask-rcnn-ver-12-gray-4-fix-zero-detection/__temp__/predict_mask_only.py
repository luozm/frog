...
def run_predict_mask_only():
    ...
    propsal_dir = \
        '/root/share/project/kaggle/science2018/results/mask-se-resnext50-rcnn_2crop-mega-05c/predict/xx_ensemble_box/proposal/npys'
    ...
    cfg.mask_test_nms_overlap_threshold   = np.inf
    ...
    for tag_name, do_test_augment, undo_test_augment, params in augments:
        ...
        ## setup  --------------------------
        tag = 'xx57_mask_only_%s'%tag_name   ##tag = 'test1_ids_gray2_53-00011000_model'
        ...
        for i in range(len(ids)):
            ...
            proposal = np.load(propsal_dir +'/%s.npy'%(name))
            ...
            assert(len(instance)==len(augment_propsal))
