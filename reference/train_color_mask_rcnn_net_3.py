...
def train_augment(image, mask, index):
    ...
    if 1:
        ...
        if type==0:
            ...
            image = random_transform(image, u=0.5, func=do_hue_shift, alpha=[-0.3,0.3])
    ...
    if 1:
        ...
        if type==0:
            ...
            image = random_transform(image, u=0.5, func=do_inv_speckle_noise, sigma=[0.1,0.2])
...
def run_train():
    ...
    out_dir = RESULTS_DIR + '/mask-se-resnext50-rcnn_2crop-color-01'
    initial_checkpoint = \
       RESULTS_DIR + '/mask-se-resnext50-purple80-decolor-00/checkpoint/00022000_model.pth'
