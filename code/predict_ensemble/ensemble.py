...
from net.draw import to_color
from utility.draw import draw_shadow_text, image_show
...
def run_ensemble_mask(split_file, out_dir, img_folder, ensemble_folders, ):
    ...
    for name in names:
        ...
        # <todo> do your predict_ensemble  here! =======================================
...
def run_ensemble_box(out_dir, ensemble_folders, ):
...
def run_ensemble_xxx(out_dir, ensemble_folders, ):
