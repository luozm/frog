...
from dataset.transform_new import relabel_mask
from net.layer.mask_nms import instance_to_binary
...
def run_check_2():
    ...
    box, label, instance = multi_mask_to_annotation(mask, min_area=16, border=0, min_size=0, max_size=np.inf )
